...
ALARM_PATH := vendor/poly/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/poly/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/poly/prebuilt/common/media/audio/ringtones
UI_PATH := vendor/poly/prebuilt/common/media/audio/ui
